...
def move(allstep,player,x,y,a,b): 
    stamin(820,346) 
    global a1,a2,b1,b2,P1_sword,P2_sword,alldeth,alldeth2,punch
    oldx = x
    oldy = y
    olda = a
    oldb = b
...
def pick_up(a1,b1,player):
    ...
    for i in range (len(Sx)):
        if a1 == Sx[i] and b1 == Sy[i]:
            ...
            break
def spawn(D1,D2):
    global a1,a2,b1,b2,P1_sword,P2_sword,alldeth,alldeth2
    if D1 == 1:    
